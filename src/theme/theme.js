...
// 2025년 부드럽고 현대적인 색상 팔레트 - 소프트 톤 조합
const colors = {
  // 메인 컬러: 소프트 블루 (차분하고 신뢰감 있는 느낌)
  primary: {
    50: '#f0f9ff',
    100: '#e0f2fe',
    200: '#bae6fd',
    300: '#7dd3fc',
    400: '#38bdf8',
    500: '#0ea5e9', // 메인 소프트 블루
    600: '#0284c7',
    700: '#0369a1',
    800: '#075985',
    900: '#0c4a6e',
  },
  // 보조 컬러: 소프트 라벤더 (우아하고 모던한 느낌)
  secondary: {
    50: '#faf5ff',
    100: '#f3e8ff',
    200: '#e9d5ff',
    300: '#d8b4fe',
    400: '#c084fc',
    500: '#a78bfa', // 메인 소프트 라벤더
    600: '#9333ea',
    700: '#7c3aed',
    800: '#6b21a8',
    900: '#581c87',
  },
  // 액센트 컬러: 소프트 민트 (신선하고 차분한 느낌)
  accent: {
    50: '#f0fdfa',
    100: '#ccfbf1',
    200: '#99f6e4',
...
// 2025년 iOS 스타일 글래스모피즘 믹스인
const commonStyles = {
  // 순수 글래스모피즘 카드 효과 (iOS 스타일)
  glassCard: {
